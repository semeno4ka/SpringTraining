...
public class StudentControllerTest {
    ...
    void getStudent_Test() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.get("/student")//pass responseBuilder right to perform
...
//not preferred way
        ...
        JSONAssert.assertEquals(expected,actual,true);//true belongs to strict() which means should be either exact match with true, or some match when false
    }
    ...
    void getStudents_Test() throws Exception {
        ...
        when(studentService.getStudents()).thenReturn(Arrays.asList(
                ...
                new StudentDTO("Tom","Hanks",50)//Create our stop-behaviour for mock objects
        ));
