...
public class DataGenerator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        paymentRepository.save(payment1);// we haven't added paymentDetails to table yet, so there is nothing to add in terms of details
        //You either need to create paymentDetailRepository.save(paymentDetails) OR
